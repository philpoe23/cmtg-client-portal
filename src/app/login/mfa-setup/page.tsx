...
import { startTotpEnrollment, confirmTotpEnrollment, logout } from "./actions";
      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        <Card>
          <CardHeader className="pb-4">
            ...
            <CardDescription>Scan this with an authenticator app (Google Authenticator, Authy, 1Password, etc.), then enter the code it generates.</CardDescription>
          </CardHeader>
          <CardContent>
            {redirecting ? (
              ...
              <p className="text-sm text-muted-foreground text-center py-4">
                Unable to load setup. Please refresh the page.
              </p>
            )}
